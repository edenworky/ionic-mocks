...
var ViewControllerMock = /** @class */ (function () {
    ...
    ViewControllerMock.navController = function () {
        ...
        instance.viewDidEnter = rxjs_1.of();
        instance.viewDidLeave = rxjs_1.of();
        instance.viewDidLoad = rxjs_1.of();
        instance.viewWillEnter = rxjs_1.of();
        instance.viewWillLeave = rxjs_1.of();
        instance.viewWillUnload = rxjs_1.of();
    };
    ViewControllerMock.instance = function () {
        ...
        instance.willEnter.and.returnValue(rxjs_1.of({}));
        instance.didEnter.and.returnValue(rxjs_1.of({}));
        instance.willLeave.and.returnValue(rxjs_1.of({}));
        instance.didLeave.and.returnValue(rxjs_1.of({}));
        instance.willUnload.and.returnValue(rxjs_1.of({}));
        instance.didUnload.and.returnValue(rxjs_1.of({}));
        ...
        instance.subscribe.and.returnValue(rxjs_1.of({}));
